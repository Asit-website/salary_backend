...
const startLine = 18953; // index 18952
const endLine = 19021;   // index 19020

const newCode = `    // HELPER: Calculate statistics for a staff member
...
console.log('Successfully fixed admin.js using line numbers');
